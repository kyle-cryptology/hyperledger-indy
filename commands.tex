...
\newcommand{\pr}{P_{r}}
\newcommand{\prp}{(h, h_0, h_1, h_2, \td{h}, pk, \hat{h}, u, y, z)}
...
\newcommand{\reqp}{(U, c, \hat{v}', \group{m_{i}}{i}{\ah},n_{1}, U_{r})}
\newcommand{\resp}{(\accv ,\mc{H}, \rc , \rr )}

\newcommand{\stp}{(V, \stpp}
\newcommand{\stpp}{\group{g_{i}, g'_{i}}{i}{\rgp{2L} \backslash \set{L + 1}})}
...
\newcommand{\openerp}{(c, \rho , \group{m_{j}}{j}{\ah}, r, s, open, open', mult, mult', tmp, tmp', r', r'', r''')}
